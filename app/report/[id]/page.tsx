...
const CSS = `
  ...
  .cover-frame-outer{width:100%;height:calc(297mm - 10mm);border:3px solid #000;padding:2.5mm;box-sizing:border-box;display:block}
...
export default function AuditReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      ...
      {/* ══ PAGE 1 — COVER ══════════════════════════════════════════════════ */}
      <div className="rp" style={{ height: "297mm", minHeight: "297mm", boxSizing: "border-box" }}>
