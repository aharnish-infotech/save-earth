...
// ── Seed Data ──────────────────────────────────────────────────────────────────
const USERS: User[] = [
  { id:uuid(), employeeId:"EMP-001", name:"Mukteshwar Sharma",  email:"mukteshwar@saveearth.in",  phone:"9876543210", role:"Super Admin",   designation:"Platform Owner",       joiningDate:"2019-03-01", bloodGroup:"B+",  emergencyContact:"9988776655", emergencyContactName:"Ravi Sharma",   emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Today",       avatarColor:"#15803d" },
  { id:uuid(), employeeId:"EMP-002", name:"Priya Sharma",       email:"priya@saveearth.in",        phone:"9876543211", role:"Admin",         designation:"Operations Manager",   joiningDate:"2020-06-15", bloodGroup:"A+",  emergencyContact:"9988776601", emergencyContactName:"Amit Sharma",   emergencyContactRelation:"Spouse",  status:"Active",   lastActive:"Today",       avatarColor:"#0284c7" },
  { id:uuid(), employeeId:"EMP-003", name:"Amit Singh",         email:"amit@saveearth.in",         phone:"9876543212", role:"Coordinator",   designation:"Audit Coordinator",    joiningDate:"2021-04-01", bloodGroup:"O+",  emergencyContact:"9988776602", emergencyContactName:"Neha Singh",    emergencyContactRelation:"Spouse",  status:"Active",   lastActive:"Yesterday",   avatarColor:"#16a34a" },
  { id:uuid(), employeeId:"EMP-004", name:"Rajesh Kumar",       email:"rajesh@saveearth.in",       phone:"9876543213", role:"Field Auditor", designation:"Senior Field Auditor", joiningDate:"2021-07-15", bloodGroup:"AB+", emergencyContact:"9988776603", emergencyContactName:"Sita Kumar",    emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Today",       avatarColor:"#059669" },
  { id:uuid(), employeeId:"EMP-005", name:"Sneha Patel",        email:"sneha@saveearth.in",        phone:"9876543214", role:"Field Auditor", designation:"Field Auditor",        joiningDate:"2022-01-01", bloodGroup:"A-",  emergencyContact:"9988776604", emergencyContactName:"Renu Patel",    emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Today",       avatarColor:"#db2777" },
  { id:uuid(), employeeId:"EMP-006", name:"Vikas Tiwari",       email:"vikas@saveearth.in",        phone:"9876543215", role:"Field Auditor", designation:"Field Auditor",        joiningDate:"2022-03-15", bloodGroup:"B-",  emergencyContact:"9988776605", emergencyContactName:"Meena Tiwari",  emergencyContactRelation:"Spouse",  status:"Active",   lastActive:"2 days ago",  avatarColor:"#ea580c" },
  { id:uuid(), employeeId:"EMP-007", name:"Divya Mehta",        email:"divya@saveearth.in",        phone:"9876543216", role:"Field Auditor", designation:"Field Auditor",        joiningDate:"2022-06-01", bloodGroup:"O-",  emergencyContact:"9988776606", emergencyContactName:"Kiran Mehta",   emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Today",       avatarColor:"#0891b2" },
  { id:uuid(), employeeId:"EMP-008", name:"Arjun Yadav",        email:"arjun@saveearth.in",        phone:"9876543217", role:"Field Auditor", designation:"Jr. Field Auditor",    joiningDate:"2023-02-01", bloodGroup:"A+",  emergencyContact:"9988776607", emergencyContactName:"Prem Yadav",    emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Today",       avatarColor:"#ca8a04" },
  { id:uuid(), employeeId:"EMP-009", name:"Sunita Verma",       email:"sunita@saveearth.in",       phone:"9876543218", role:"Coordinator",   designation:"Audit Coordinator",    joiningDate:"2021-09-15", bloodGroup:"B+",  emergencyContact:"9988776608", emergencyContactName:"Raj Verma",     emergencyContactRelation:"Spouse",  status:"On Leave", lastActive:"5 days ago",  avatarColor:"#8b5cf6" },
  { id:uuid(), employeeId:"EMP-010", name:"Karan Joshi",        email:"karan@saveearth.in",        phone:"9876543219", role:"Field Auditor", designation:"Field Auditor",        joiningDate:"2023-05-15", bloodGroup:"AB-", emergencyContact:"9988776609", emergencyContactName:"Asha Joshi",    emergencyContactRelation:"Parent",  status:"Inactive", lastActive:"3 weeks ago", avatarColor:"#374151" },
  { id:uuid(), employeeId:"EMP-011", name:"Pooja Gupta",        email:"pooja@saveearth.in",        phone:"9876543220", role:"Admin",         designation:"Admin Officer",        joiningDate:"2022-08-01", bloodGroup:"O+",  emergencyContact:"9988776610", emergencyContactName:"Manoj Gupta",   emergencyContactRelation:"Spouse",  status:"Active",   lastActive:"Today",       avatarColor:"#16a34a" },
  { id:uuid(), employeeId:"EMP-012", name:"Deepak Nair",        email:"deepak@saveearth.in",       phone:"9876543221", role:"Field Auditor", designation:"Sr. Field Auditor",    joiningDate:"2020-11-01", bloodGroup:"A+",  emergencyContact:"9988776611", emergencyContactName:"Latha Nair",    emergencyContactRelation:"Parent",  status:"Active",   lastActive:"Yesterday",   avatarColor:"#dc2626" },
];
...
type FormData = {
  ...
  designation: string; employeeId: string; joiningDate: string;
...
export default function UsersPage() {
  ...
  const openEdit = (u: User) => {
    ...
    setForm({
      ...
      designation: u.designation, employeeId: u.employeeId, joiningDate: u.joiningDate,
