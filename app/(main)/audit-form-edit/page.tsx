...
function MeterDetailsSection({ branchName }: { branchName: string }) {
  ...
  return (
    <div>
      ...
      {/* Add Meter — removed in Edit mode */}
...
function ElectricalParametersSection({ branchName }: { branchName: string }) {
  ...
  return (
    <div>
      ...
      {/* Add Panel — removed in Edit mode */}
      ...
      <div style={SEC_CARD}>
        ...
        {secOpen.ups && (
          <div style={{ padding:"14px" }}>
            ...
            {/* Add ATM UPS — removed in Edit mode */}
          </div>
        )}
      </div>
    ...
    <div>
      ...
      <div style={{ ...card, overflow:"hidden", marginBottom:14 }}>
        ...
        <div style={{ padding:"14px" }}>
          ...
          {/* Add DG Set — removed in Edit mode */}
        </div>
      </div>
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:24 }}>
        <div>
          ...
          <div style={{ fontSize:12, color:"#9ca3af", marginTop:3 }}>
            Dashboard / Audits / <span style={{ color:active.color, fontWeight:600 }}>Edit Audit</span>
          </div>
        </div>
        {branchData && (
