...
export const RAIL_ITEMS: RailItem[] = [
  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        ...
        { label: "Lost / Inactive",     href: "/admission-crm/lost-leads",icon: "ri-user-unfollow-line"  },
      ],
    }],
  },
  {
  ...
  },
  {
    ...
    sections: [{
      ...
      items: [
        { label: "Employees",   href: "/hr/employees",   icon: "ri-user-2-line"         },
        { label: "Attendance",  href: "/hr/attendance",  icon: "ri-calendar-check-line" },
        { label: "Leaves",      href: "/hr/leaves",      icon: "ri-calendar-close-line" },
        { label: "Holiday",     href: "/hr/holidays",    icon: "ri-flag-line"           },
        { label: "Designation", href: "/hr/designation", icon: "ri-award-line"          },
        { label: "Department",  href: "/hr/department",  icon: "ri-building-2-line"     },
      ],
    }],
  },
  {
